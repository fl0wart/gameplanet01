...
my_token = 'NTU2Mzc1NDg1NjM5MTYzOTI1.D241eA.mX9gcWly0SQn9yLIEzSCtwwmdRQ'

client = commands.Bot(command_prefix = 'gp!')

client.remove_command('help')
status = ['with GamePlanet!', "with GamePlanet!"]
...
client.run('NTU2Mzc1NDg1NjM5MTYzOTI1.D241eA.mX9gcWly0SQn9yLIEzSCtwwmdRQ')
